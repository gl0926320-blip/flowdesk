  ...
  useEffect(() => {
    async function loadActiveCompany() {
      try {
        ...
        if (userError) {
          console.error("Erro ao buscar usuário da FlowIA:", userError);
          return;
        }
        ...
        if (membershipError) {
          console.error("Erro ao buscar company_id da FlowIA:", membershipError);
          return;
        }
        ...
        console.error("Erro ao carregar companyId ativo:", error);
      }
    }
